        ...
        <div className="flex flex-col md:flex-row bg-white-A700 font-inika mx-auto w-full">
            ...
            <div className="relative bg-gray-100 col-span-2 items-center justify-start md:ml-0 w-full">
                ...
                <div className="text-center mt-[10%]">
                    ...
                    <h1 className="p-5 text-gray-500">Pay online through UMaTPay</h1>
                        ...
                        {paymentMethods.map(({ name, logo }) => (
                            <button
                                ...
                                className={`flex-1 flex items-center py-2 text-center text-lg font-semibold rounded-lg shadow-md transition duration-200 p-5 ${
                                    activeTab === name
                                        ? 'text-teal-600 bg-white border-teal-600 border'
                    ...
                    <div className="ml-auto mr-auto w-[80%] h-[40px] p-2" >
                        OR
                    </div>
                    <div className="ml-auto mr-auto w-[80%] h-[300px] bg-white-700 bg-white-A700 shadow-md">
                    <h1 className="p-5 text-gray-500">Visit the following banks to make payment</h1>
                            ...
                            <div className="flex justify-between w-full pl-10 pr-10">
                                <div className="flex-1 p-6 bg-gradient-to-r from-orange-100 to-orange-700 rounded-lg shadow-lg text-white relative overflow-hidden">
                                ...
                                <div className="flex-1 p-6 bg-gradient-to-r from-teal-100 to-green-700 rounded-lg shadow-lg text-white relative overflow-hidden">
                                    <div className="flex items-center mb-4">
                                ...
                                <div className="flex-1 p-6 bg-gradient-to-r from-yellow-100 to-yellow-700 rounded-lg shadow-lg text-white relative overflow-hidden">
                                    <div className="flex items-center mb-4">
